...
class SparseResNet(nn.Module):
    def __init__(self, block, num_blocks, sparsities, num_classes=1000, use_relu=True, sparse_func='reg', bias=True):
...
def SparseResNet18(num_classes, relu=False, sparsities=[0.5,0.4,0.3,0.2], sparse_func='reg', bias=False):
    return SparseResNet(SparseBasicBlock, [2,2,2,2], sparsities, use_relu=relu, sparse_func=sparse_func, bias=bias, num_classes=num_classes)

def SparseResNet34(num_classes, relu=False, sparsities=[0.5,0.4,0.3,0.2], sparse_func='reg', bias=False):
    return SparseResNet(SparseBasicBlock, [3,4,6,3], sparsities, use_relu=relu, sparse_func=sparse_func, bias=bias, num_classes=num_classes)

def SparseResNet50(num_classes, relu=False, sparsities=[0.5,0.4,0.3,0.2], sparse_func='reg', bias=False):
    return SparseResNet(SparseBottleneck, [3,4,6,3], sparsities, use_relu=relu, sparse_func=sparse_func, bias=bias, num_classes=num_classes)

def SparseResNet101(num_classes, relu=False, sparsities=[0.5,0.4,0.3,0.2], sparse_func='reg', bias=False):
    return SparseResNet(SparseBottleneck, [3,4,23,3], sparsities, use_relu=relu, sparse_func=sparse_func, bias=bias, num_classes=num_classes)

def SparseResNet152(num_classes, relu=False, sparsities=[0.5,0.4,0.3,0.2], sparse_func='reg', bias=False):
    return SparseResNet(SparseBottleneck, [3,8,36,3], sparsities, use_relu=relu, sparse_func=sparse_func, bias=bias, num_classes=num_classes)
